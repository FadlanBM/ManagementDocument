    ...
    public partial class FLogin : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (tb_username.Text.Length == 0) {
                ...
                errorProvider1.SetError(tb_username, "Form password belum terisi");
                return;
            }
            else
            {
            ...
            {
                errorProvider1.SetError(tb_password, "Form password belum terisi");
                return;
            }
            else
            {
            ...
            var user = context.tb_users.Where(u =>u.username == tb_username.Text&& u.level == 0).FirstOrDefault();
            if (user == null) { 
