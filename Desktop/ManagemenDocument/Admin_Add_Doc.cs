...
namespace ManagemenDocument
{
    public partial class Admin_Add_Doc : Form
    {
        ...
        {
                if (tb_nameDoc.Text == "" || text3.Text == "" || tb_pengirim.Text == "" || tb_perihalDoc.Text == "" || tb_agendaDoc.Text == "" || tbUraianDoc.Text == "" || dt_agendastart.Text == "" || dt_agendafinish.Text == "" || dt_tgldocumen.Text == "" || dt_tglPenerima.Text == ""||pictureBox1.Image==null)
            {
            ...
            var penerima = context.tb_users.Where(u => u.id_user == Helper.helper.id.id_user).FirstOrDefault();
            if (penerima == null)
            {
        ...
        private void dt_tglPenerima_ValueChanged(object sender, EventArgs e)
        {
