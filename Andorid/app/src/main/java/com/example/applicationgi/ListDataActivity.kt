...
class ListDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       val id = intent.getStringExtra("id")
        GetDataDoc(this,binding,id!!).execute()
        ...
        binding.btnKonfirmasi.setOnClickListener {
            ValidDocUser(this,id).execute()
        }
    }

    @Suppress("DEPRECATION")
    class ValidDocUser(private var context: Context,private val idDoc:String):AsyncTask<String,String,String>(){
    ...
    @Suppress("DEPRECATION")
    class GetDataDoc(private val context: Context,private val binding: ActivityListdataBinding,private val ids:String):AsyncTask<String,String,String>(){
